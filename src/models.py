...
class SSHConnection(BaseModel):
    ...
    hostname: Optional[str] = Field(None, description="SSH config hostname (if different from host)")
    ...
    remote_forward: Optional[str] = Field(None, description="RemoteForward configuration")
    extra_options: dict = Field(default_factory=dict, description="Additional SSH options")
